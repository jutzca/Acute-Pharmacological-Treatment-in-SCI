...
prevent.indication.drugs.per.patient <- prevent.indication  %>%
  ...
  dplyr::count(indication, sort = TRUE)
prevent.indication.drugs.per.patient
...
# Save plot
ggsave(
  "prevent.indication.drugs.per.patient.plot.sygen.pdf",
  plot = prevent.indication.drugs.per.patient.plot,
  device = 'pdf',
  path = outdir_figures,
  scale = 1,
  width = 14,
